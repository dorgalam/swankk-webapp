...
const emptyEra: EraItem = { title: '', year_range: '', image_url: '', caption: '', credit: '' }
const emptyPiece: PieceItem = { name: '', image_url: '', brand: '', price: '', farfetch_url: '' }
...
export default function DesignerForm() {
  ...
  useEffect(() => {
    if (isEdit && existing) {
      setForm(existing as unknown as DesignerFormState)
