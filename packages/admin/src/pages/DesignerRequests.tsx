...
export default function DesignerRequests() {
  ...
  const [menuRow, setMenuRow] = useState<{ id: number; status: string; designer_name: string; email: string } | null>(null)
  ...
  const handleConvert = (req: { id: number; designer_name: string }) => {
